...
<head>
	<meta charset="UTF-8">
	<title>学生选课</title>
	<link rel="stylesheet" href="/Grade_Serching_System/Public/css/student_chooseCourse.css" />
</head>
...
<body class="all">
	...
	<table cellspacing="0" class="table">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="td2">
					<?php if($vo[stuno] == ''): ?><a href="/Grade_Serching_System/index.php/Admin/Student/chooseCourseDo/couno/<?php echo ($vo["couno"]); ?>">添加</a>
						<?php else: ?>
						<c>已选</c><?php endif; ?>
				</td>
