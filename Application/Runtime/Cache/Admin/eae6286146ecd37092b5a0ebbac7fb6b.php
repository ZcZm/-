...
<head>
	<meta charset="UTF-8">
	<title>教师管理课程</title>
	<link rel="stylesheet" href="/Grade_Serching_System/Public/css/teacher_coulist.css" />
</head>
...
<body class="all">
	...
	<table cellspacing="0" class="table">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td class="td" name='couno'><?php echo ($vo["couno"]); ?></td>
      ...
      <form method="post" action="/Grade_Serching_System/index.php/Admin/Teacher/courseListDetail">
          <td class="td2">
      ...
      <form method="post" action="/Grade_Serching_System/index.php/Admin/Teacher/edit/id/<?php echo ($vo["couno"]); ?>">
				<td class="td2">
					<input type="hidden" name="CouNo" value="<?php echo ($vo["couno"]); ?>" class="button"/>
			...
			<td class="td2"><a href="/Grade_Serching_System/index.php/Admin/Teacher/delete/id/<?php echo ($vo["couno"]); ?>" onclick="return confirm('确定删除?')">删除</a></td>
