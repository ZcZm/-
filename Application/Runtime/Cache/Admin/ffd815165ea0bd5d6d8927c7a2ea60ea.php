...
<head>
	<meta charset="UTF-8">
	<title>学生已选课程</title>
    <link rel="stylesheet" href="/Grade_Serching_System/Public/css/student_courseList.css" />
</head>
    ...
    <table cellspacing="0" class="table">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               <td class="td"><?php echo ($vo["CouNo"]); ?></td>
                ...
                <td class="td2"><a href="/Grade_Serching_System/index.php/Admin/Student/delete/CouNo/<?php echo ($vo["CouNo"]); ?>">删除</a></td>
